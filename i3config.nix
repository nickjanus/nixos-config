...
writeText "i3-config" ''
  ...
  bindsym XF86AudioRaiseVolume exec --no-startup-id ${pulseaudio}/bin/pactl set-sink-volume 1 +5% #increase sound volume
  bindsym XF86AudioLowerVolume exec --no-startup-id ${pulseaudio}/bin/pactl set-sink-volume 1 -5% #decrease sound volume
  bindsym XF86AudioMute exec --no-startup-id ${pulseaudio}/bin/pactl set-sink-mute 1 toggle # mute sound
